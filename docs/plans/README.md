...
- I'll build *drivers* and *runtimes* for *bare metal* and *operating systems* contexts.
  - Learn Fundamental Concepts
    - _Learn_ is intentionally vague here. It means whatever it takes to understand a concept.
  - Build Projects[^n]
  - Open Source & Prior Art: Study or/and Contribute[^n].
...
My end goal is to be able to model electronics with organic shapes.
